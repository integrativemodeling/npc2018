...
if (True):
    ...
    dr = IMP.pmi.restraints.basic.DistanceRestraint(simo,(549,549,"pom152"), (1311,1311,"pom152"), distancemin=dist_min,distancemax=dist_max,resolution=res_str)
    dr.add_to_model()
...
if (inputs.em2d_input is not None):
    if (False):
        ...
        for class_num in range(0, 5):
            spi = "../data/em2d/no_bg." + str(class_num) + ".spi"
            images.append(spi)
