...
dmap = IMP.em.read_map("./SJ_r_09_02_resfilt143_rotated.mrc")
step_size = 1.0
voxel_size = 5.3
#threshold = 0.0035
threshold = 0.012
...
for i in np.arange(0, dmap.get_header().get_nz(), step_size):
    ...
    for j in np.arange(0, dmap.get_header().get_ny(), step_size):
        ...
        for k in np.arange(0, dmap.get_header().get_nx(), step_size):
            ...
            #else:
            #    dmap.set_value(x,y,z, 0.0)
#IMP.em.write_map(dmap, "./SJ_ynpc_eman_06_01_sym_cleaned_rotated90.mrc")
IMP.em.write_map(dmap, "./SJ_r_09_02_resfilt143_rotated90.mrc")
dmap2 = dmap.get_cropped(0.00001)
IMP.em.write_map(dmap2, "SJ_cropped_r_09_02_resfilt143_rotated90.mrc")
