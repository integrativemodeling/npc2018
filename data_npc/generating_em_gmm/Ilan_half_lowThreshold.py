...
dmap = IMP.em.read_map("./SJ_cropped_sym8_avg_monomer_final_rotated_adjusted90_2.mrc")
step_size = 1.0
voxel_size = 5.3
threshold = 0.002
...
IMP.em.write_map(dmap2, "SJ_SamplingBoundary_lowThreshold.mrc")
#IMP.em.write_map(dmap, "SJ_SamplingBoundary_lowThreshold.mrc")
