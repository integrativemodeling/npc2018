...
if (is_n84):
    ...
    n84_rb = 84;    n133_rb = 84;  n120_rb = 84
...
if (is_nic96):
    ...
    domains.append(("Nic96.1",  "Nic96.1",    0.25, f_n96+"Nic96.txt", "YFR002W", n961_pdb, "A",  (205,839,0),  gmm,  beadsize,    1096,   [1096],   3,  " ",   " ",  None, False))
    if (is_FG):
    ...
    domains.append(("Nic96.2",  "Nic96.2",    0.25, f_n96+"Nic96.txt", "YFR002W", n962_pdb, "A",  (205,839,0),  gmm,  beadsize,    1096,   [1096],   3,  " ",   " ",  None, False))
    if (is_FG):
...
if (True):
    ...
    if (is_nic96):
        ...
        nic96_dict={'Nsp1.3':'Nsp1', 'Nup49.1':'Nup49', 'Nup57.1':'Nup57', 'Nsp1.4':'Nsp1', 'Nup49.2':'Nup49', 'Nup57.2':'Nup57'}
...
if (use_shuffle) :
    ...
    #simo.shuffle_configuration(bounding_box=((200, -150, 0), (450, 150, 150)), ignore_initial_coordinates=True, cutoff=1.0, niterations=1000)
