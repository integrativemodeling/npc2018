...
##########################
if (is_basket):
    #domains.append((    "Mlp1",      "Mlp1n",     0.0, f_npc+"Mlp1.txt",   "YKR095W", "BEADS",   " ", (  1, 237,0), gmm,  beadsize100, 9191,  None,   0,  None,  None, None))
    domains.append((    "Mlp1",      "Mlp1",      0.0, f_npc+"Mlp1.txt",   "YKR095W", "BEADS",   " ", (238, 716,0), gmm,  beadsize50,  None,  None,   0,  None,  None, None))
    domains.append((    "Mlp1",      "Mlp1c",     0.0, f_npc+"Mlp1.txt",   "YKR095W", "BEADS",   " ", (717,1875,0), gmm,  beadsize100, 9192,  None,   0,  None,  None, None, False))
    #domains.append((    "Mlp2",      "Mlp2n",     0.2, f_npc+"Mlp2.txt",   "YIL149C", "BEADS",   " ", (  1, 214,0), gmm,  beadsize100, 9193,  None,   0,  None,  None, None))
    domains.append((    "Mlp2",      "Mlp2",      0.2, f_npc+"Mlp2.txt",   "YIL149C", "BEADS",   " ", (215, 690,0), gmm,  beadsize50,  None,  None,   0,  None,  None, None))
    domains.append((    "Mlp2",      "Mlp2c",     0.2, f_npc+"Mlp2.txt",   "YIL149C", "BEADS",   " ", (691,1679,0), gmm,  beadsize100, 9194,  None,   0,  None,  None, None, False))
    for i in clones_range_B:
...
for protein in [(248,360,'Nup53'), (266,402,'Nup59'), (379,1337,'Pom152'), (238,716,'Mlp1'), (215,690,'Mlp2')]:
    rigid_tuples.append(protein)
...
if (use_shuffle) :
    ...
    simo.shuffle_configuration(bounding_box=((150, -150, -500), (750, 150, 100)), ignore_initial_coordinates=True, cutoff=1.0, niterations=1000)
