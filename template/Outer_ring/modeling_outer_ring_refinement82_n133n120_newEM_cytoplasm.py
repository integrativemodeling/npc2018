...
if (use_Immuno_EM):
    ...
    """
    zax = IMP.pmi1.restraints.npc.ZAxialPositionRestraint(simo, (1155,1155,"Nup133"), lower_bound=130, upper_bound=400, consider_radius=False, sigma=1.0, term='M')
...
if (is_n84):
    ...
    """
    msl = IMP.pmi1.restraints.npc.MembraneSurfaceLocationRestraint(simo, (135,152,'Nup120'), tor_R=tor_R, tor_r=tor_r_ALPS, tor_th=tor_th_ALPS, sigma=msl_sigma, resolution = res_ev)
    msl.set_label('Nup120_1')
    msl.set_weight(msl_weight)
    msl.add_to_model()
    outputobjects.append(msl)
    ...
    msl = IMP.pmi1.restraints.npc.MembraneSurfaceLocationRestraint(simo, (197,216,'Nup120'), tor_R=tor_R, tor_r=tor_r_ALPS, tor_th=tor_th_ALPS, sigma=msl_sigma, resolution = res_ev)
    msl.set_label('Nup120_2')
    msl.set_weight(msl_weight)
    msl.add_to_model()
    outputobjects.append(msl)
