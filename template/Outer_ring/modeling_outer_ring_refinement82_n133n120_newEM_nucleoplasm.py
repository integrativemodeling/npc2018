...
if (use_neighboring_spokes):
    ...
    clones_range_A = range(2,3)+range(11,13)
...
if (use_neighboring_spokes):
    if (is_n84):
        for protein in ['Nup84', 'Nup85', 'Nup120', 'Nup133', 'Nup145c', 'Seh1', 'Sec13']:
            ...
            simo.create_rotational_symmetry(protein+'@11', [protein+'@%d'%i for i in range(12,13)], rotational_axis=IMP.algebra.Vector3D(0, 0, 1.0), nSymmetry=8, skip_gaussian_in_clones=True)
    if (is_n82):
...
for protein in [(1117,1460,'Nup159.1'),(1117,1460,'Nup159.2'), (637,823,'Nsp1.1'),(637,823,'Nsp1.2')]:
    rigid_tuples.append(protein)
"""
...
if (is_inner_ring and use_Immuno_EM):
    xyr = IMP.pmi1.restraints.npc.XYRadialPositionRestraint(simo, (477,477,"Nup188"), lower_bound=200, upper_bound=340, consider_radius=False, sigma=1.0, term='M')
    ...
    zax = IMP.pmi1.restraints.npc.ZAxialPositionRestraint(simo, (477,477,"Nup188"), lower_bound=40, upper_bound=180, consider_radius=False, sigma=1.0, term='M')
    ...
    xyr = IMP.pmi1.restraints.npc.XYRadialPositionRestraint(simo, (303,303,"Nup192"), lower_bound=200, upper_bound=340, consider_radius=False, sigma=1.0, term='M')
    ...
    zax = IMP.pmi1.restraints.npc.ZAxialPositionRestraint(simo, (303,303,"Nup192"), lower_bound=0, upper_bound=130, consider_radius=False, sigma=1.0, term='M')
...
if (is_nic96 and use_Immuno_EM):
    xyr = IMP.pmi1.restraints.npc.XYRadialPositionRestraint(simo, (360,360,"Nic96.1"), lower_bound=200, upper_bound=350, consider_radius=False, sigma=1.0, term='M')
    ...
    zax = IMP.pmi1.restraints.npc.ZAxialPositionRestraint(simo, (360,360,"Nic96.1"), lower_bound=40, upper_bound=140, consider_radius=False, sigma=1.0, term='M')
    ...
    xyr = IMP.pmi1.restraints.npc.XYRadialPositionRestraint(simo, (360,360,"Nic96.2"), lower_bound=200, upper_bound=350, consider_radius=False, sigma=1.0, term='M')
    ...
    zax = IMP.pmi1.restraints.npc.ZAxialPositionRestraint(simo, (360,360,"Nic96.2"), lower_bound=0, upper_bound=100, consider_radius=False, sigma=1.0, term='M')
...
if (is_inner_ring):
    ...
    if (use_end_to_end_157_170):
        ...
        dr = IMP.pmi1.restraints.basic.DistanceRestraint(simo,(227,227,"Nup157"), (1385,1385,"Nup157"), distancemin=160, distancemax=220, resolution=1.0)
        dr.add_to_model()
        ...
        dr = IMP.pmi1.restraints.basic.DistanceRestraint(simo,(237,237,"Nup170"), (1491,1491,"Nup170"), distancemin=160, distancemax=220, resolution=1.0)
        dr.add_to_model()
...
if (is_membrane):
    ...
    zax = IMP.pmi1.restraints.npc.ZAxialPositionRestraint(simo, (379,379,"Pom152"), lower_bound=5, upper_bound=55, consider_radius=False, sigma=1.0, term='M')
    ...
    zax = IMP.pmi1.restraints.npc.ZAxialPositionRestraint(simo, (520,520,"Pom152"), lower_bound=5, upper_bound=55, consider_radius=False, sigma=1.0, term='M')
    ...
    zax = IMP.pmi1.restraints.npc.ZAxialPositionRestraint(simo, (616,616,"Pom152"), lower_bound=5, upper_bound=55, consider_radius=False, sigma=1.0, term='M')
    ...
    zax = IMP.pmi1.restraints.npc.ZAxialPositionRestraint(simo, (722,722,"Pom152"), lower_bound=5, upper_bound=55, consider_radius=False, sigma=1.0, term='M')
    ...
    zax = IMP.pmi1.restraints.npc.ZAxialPositionRestraint(simo, (824,824,"Pom152"), lower_bound=5, upper_bound=55, consider_radius=False, sigma=1.0, term='M')
    ...
    zax = IMP.pmi1.restraints.npc.ZAxialPositionRestraint(simo, (931,931,"Pom152"), lower_bound=5, upper_bound=55, consider_radius=False, sigma=1.0, term='M')
    ...
    zax = IMP.pmi1.restraints.npc.ZAxialPositionRestraint(simo, (1036,1036,"Pom152"), lower_bound=5, upper_bound=55, consider_radius=False, sigma=1.0, term='M')
    ...
    zax = IMP.pmi1.restraints.npc.ZAxialPositionRestraint(simo, (1150,1150,"Pom152"), lower_bound=5, upper_bound=55, consider_radius=False, sigma=1.0, term='M')
    ...
    zax = IMP.pmi1.restraints.npc.ZAxialPositionRestraint(simo, (1244,1244,"Pom152"), lower_bound=5, upper_bound=55, consider_radius=False, sigma=1.0, term='M')
...
if (is_nucleoplasm):
    ...
    msl = IMP.pmi1.restraints.npc.MembraneSurfaceLocationRestraint(simo, (27,47,'Nup60.1'), tor_R=tor_R, tor_r=tor_r_ALPS, tor_th=tor_th_ALPS, sigma=msl_sigma)
    ...
    msl = IMP.pmi1.restraints.npc.MembraneSurfaceLocationRestraint(simo, (27,47,'Nup60.2'), tor_R=tor_R, tor_r=tor_r_ALPS, tor_th=tor_th_ALPS, sigma=msl_sigma)
...
if (is_n84 and use_neighboring_spokes):
    dist_max = 30.0
    dr = IMP.pmi1.restraints.basic.DistanceRestraint(simo,(217,217,"Nup120@2"), (239,239,"Nup133"), distancemin=dist_min, distancemax=dist_max, resolution=1.0)
    dr.add_to_model()
    ...
    dr = IMP.pmi1.restraints.basic.DistanceRestraint(simo,(431,431,"Nup120@2"), (191,191,"Nup133"), distancemin=dist_min, distancemax=dist_max, resolution=1.0)
    dr.add_to_model()
...
if (use_sampling_boundary):
    ...
    sbr = IMP.pmi1.restraints.em.GaussianEMRestraint(resdensities,
                                                    '../data_npc/em_gmm_model/SJ_outer_ring_newEM.gmm.60.txt',
