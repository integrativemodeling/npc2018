...
if (True):
    ...
    #d.set_coordinates((417.0, 195.0, 150.0))       # -> 433.77, 154.135, 150
    #d.set_coordinates((338.0, -170.0, 170.0))      # -> 320.15, -201.613, 170
    d.set_coordinates((556.0, -160.0, 110.0))       # -> 538.105, -212.554, 110
...
IMP.isd.gmm_tools.write_gmm_to_text(ps, "avg_monomer_final_sj2_ring_5p5rot.456.txt")
IMP.isd.gmm_tools.write_gmm_to_map(ps, "avg_monomer_final_sj2_ring_5p5rot.456.mrc", voxel_size=5.6, fast=True)
