...
n116_pdb       = npc + "Outer_ring_rmfs/OR_84844_newEM_NE_noBEA.pdb"
...
if (is_n84):
    ...
    n84_rb = 84;    n133_rb = 84;  n120_rb = 84;  n120c_rb = 84;    n85_rb = 84
...
if (is_n82):
    ...
    domains.append(("Nup116.1","Nup116.1",    0.75,  f_n82+"Nup116.txt", "Nup116", n116_pdb, "X", ( 751,1113,0),  None,   beadsize25, n82_rb, [n82_rb], 0,  None,  None, None, False))
    domains.append(("Nup116.2","Nup116.2",    0.8,   f_n82+"Nup116.txt", "Nup116", n116_pdb, "Y", ( 751,1113,0),  None,   beadsize25, n82_rb, [n82_rb], 0,  None,  None, None, False))
    for i in clones_range_B:
        ...
        domains.append(("Nup116.1@%d"%i,"Nup116.1@%d"%i,    0.75,  f_n82+"Nup116.txt", "Nup116", n116_pdb, "X", ( 751,1113,0),  None, beadsize25,  None,  None,  0,  None,  None,  None))
        domains.append(("Nup116.2@%d"%i,"Nup116.2@%d"%i,    0.8,   f_n82+"Nup116.txt", "Nup116", n116_pdb, "Y", ( 751,1113,0),  None, beadsize25,  None,  None,  0,  None,  None,  None))
...
##########################
if (is_membrane):
    domains.append(("Nup53",     "Nup53",         0.0,  f_npc+"Nup53.txt",  "YMR153W", n53_pdbfile,  "A", (   1, 475,0),  gmm,  beadsize50,  53,   None,  2,  " ",   " ",  None, False))
    domains.append(("Nup59",     "Nup59",         0.66, f_npc+"Nup59.txt",  "YDL088C", n59_pdbfile,  "A", (   1, 528,0),  gmm,  beadsize50,  59,   None,  2,  " ",   " ",  None, False))
    domains.append(("Ndc1",      "Ndc1",          0.8,  f_npc+"Ndc1.txt",   "YML031W", "BEADS",      " ", (   1, 655,0),  gmm,  beadsize100, 101,  None,  0,  None,  None, None, False))
    domains.append(("Pom34",     "Pom34",         0.9,  f_npc+"Pom34.txt",  "YLR018C", "BEADS",      " ", (   1, 299,0),  gmm,  beadsize50,  34,   None,  0,  None,  None, None, False))
...
if (is_cytoplasm):
    ...
    domains.append(("Nup100.1", "Nup100.1",    0.2, f_npc+"Nup100.txt", "YKL068W", n100_pdbfile, "A", (551, 959,0), None, beadsize25,  1100, None,  2,  " ",   " ",  None, False))
    domains.append(("Nup100.2", "Nup100.2",    0.4, f_npc+"Nup100.txt", "YKL068W", n100_pdbfile, "B", (551, 959,0), None, beadsize25,  2100, None,  2,  " ",   " ",  None, False))
    ...
    domains.append(("Nup42",    "Nup42",       0.6, f_npc+"Nup42.txt",  "YDR192C", "BEADS",      " ", (364, 430,0), None, beadsize50,  42,   None,  0,  None,  None, None, False))
...
if (is_nucleoplasm):
    ...
    domains.append(("Nup145.1", "Nup145.1",    0.7, f_npc+"Nup145.txt", "YGL092W", n145N_pdbfile,"A", (201, 605,0), None, beadsize25,  1145, None,   2,  " ",   " ",  None, False))
    domains.append(("Nup145.2", "Nup145.2",    0.75,f_npc+"Nup145.txt", "YGL092W", n145N_pdbfile,"B", (201, 605,0), None, beadsize25,  2145, None,   2,  " ",   " ",  None, False))
    domains.append(("Nup1",     "Nup1",        0.8, f_npc+"Nup1.txt",   "YOR098C", "BEADS",      " ", (  1, 351,0), None, beadsize50,  1,    None,   0,  None,  None, None, False))
...
if (enforce_outer_ring and is_n84 and use_neighboring_spokes):
    ...
    dr = IMP.pmi1.restraints.basic.DistanceRestraint(simo,(191,191,"Nup133"), (431,431,"Nup120@2"), distancemin=dist_min, distancemax=dist_max, resolution=1.0)
    dr.add_to_model()
    ...
    dr = IMP.pmi1.restraints.basic.DistanceRestraint(simo,(11,11,"Nup133"), (641,641,"Nup120@2"), distancemin=dist_min, distancemax=dist_max, resolution=1.0)
    dr.add_to_model()
    dr.set_label("Nup133-Nup120@2")
    dr.set_weight(dr_weight)
    outputobjects.append(dr)
...
if (use_sampling_boundary):
    ...
    sbr = IMP.pmi1.restraints.em.GaussianEMRestraint(resdensities,
                                                    '../data_npc/em_gmm_model/SJ_cropped_ynpc_eman_06_01_sym_cleaned_rotated90.gmm.200.txt',
...
if (use_EM3D):
    ...
    gem = IMP.pmi1.restraints.em.GaussianEMRestraint(resdensities,
                                                    '../data_npc/em_gmm_model/SJ_cropped_ynpc_eman_06_01_sym_cleaned_rotated90.gmm.1000.txt',
                                                    target_mass_scale=mass,
                                                    #slope=0.0000005,
                                                    slope=0.0000001,
                                                    target_radii_scale=3.0)
