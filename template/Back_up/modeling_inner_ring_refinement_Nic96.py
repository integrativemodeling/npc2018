...
if (use_Immuno_EM):
    ...
    RADIAL = {
        ...
        "Seh1"     : [250, 370],
        "Pom152"   : [370, 630]     #(Table S2 and Table S7 are different)
    }
    ...
    ZAXIAL = {
        ...
        "Pom152"   : [   0,  50]        #"Pom152"   : [   0,  95]   (Table S2 and Table S7 are different)
    }
...
if (True):
    print "\nZAxialPositionRestraint !!"
    zax = IMP.pmi1.restraints.npc.ZAxialPositionRestraint(simo, (835,835,"Nic96.1"), lower_bound=25, upper_bound=175, consider_radius=False, sigma=1.0, term='M')
    ...
    zax = IMP.pmi1.restraints.npc.ZAxialPositionRestraint(simo, (835,835,"Nic96.2"), lower_bound=25, upper_bound=175, consider_radius=False, sigma=1.0, term='M')
